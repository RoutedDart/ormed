...
- How to initialize and manage multiple named datasources
- How to route queries by connection context
- How to structure multi-DB patterns for reliability

## Step Outcome

By the end of this page, you should be able to:

- Boot and use multiple named `DataSource` instances
- Route operations to the intended connection explicitly
- Avoid common cross-database consistency pitfalls
...
Never assume ACID guarantees across separate database connections; design explicit compensation/retry logic.
...
## Verify Multi-DB Wiring

1. Run one query against each named datasource.
2. Confirm default/static helper behavior points to expected connection.
3. Add tests for connection-specific query paths.
