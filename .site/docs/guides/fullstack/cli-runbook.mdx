...
- How operational tasks map to CLI commands
- How to structure a runbook for repeatable environments
- How to keep app runtime and migration runtime in sync

## Step Outcome

By the end of this page, you should have:

- A consistent command surface for serve/migrate/seed
- A repeatable local workflow for daily development
- A single checklist you can run before opening a PR
...
Run this sequence when you pull new changes or before review:
