...
```dart file=../../../../packages/ormed/example/fullstack/lib/src/server/server.dart#server-bootstrap-deps
```

```dart file=../../../../packages/ormed/example/fullstack/lib/src/server/server.dart#server-bootstrap-pipeline
