...
- How the tutorial harness isolates app state
- When to run in-memory vs live-server tests
- How `ormedGroup` supports reliable integration tests

## Step Outcome

By the end of this page, you should have:

- A repeatable harness for DB + HTTP integration tests
- Coverage for web routes, JSON APIs, and property-based stress cases
- Optional Playwright checks for UI-level behavior
...
```dart file=../../../../packages/ormed/example/fullstack/test/support/movie_catalog_harness.dart#testing-setup-config
```

```dart file=../../../../packages/ormed/example/fullstack/test/support/movie_catalog_harness.dart#testing-setup-harness-init
```

```dart file=../../../../packages/ormed/example/fullstack/test/support/movie_catalog_harness.dart#testing-setup-harness-handler
...
```bash
# Core Dart tests (web + api + property)
dart test

# Run only API tests
dart test test/movie_catalog_api_test.dart

# Run only property tests
dart test test/movie_catalog_property_test.dart
```
...
<Tabs groupId="web-tests">
  ...
  <TabItem value="create" label="Create">
    ...
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_web_test.dart#testing-web-create-arrange
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_web_test.dart#testing-web-create-request
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_web_test.dart#testing-web-create-assertions
    ```
  </TabItem>
  <TabItem value="delete" label="Delete">
    Verifies that deleting a movie removes it from the database.
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_web_test.dart#testing-web-delete-confirmation
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_web_test.dart#testing-web-delete-flow
    ```
  </TabItem>
</Tabs>
...
<Tabs groupId="api-tests">
  <TabItem value="list" label="List">
    ...
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_api_test.dart#testing-api-list-movies-core
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_api_test.dart#testing-api-list-genres-core
    ```
  </TabItem>
  <TabItem value="create" label="Create">
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_api_test.dart#testing-api-create-request
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_api_test.dart#testing-api-create-assertions
    ```
  </TabItem>
</Tabs>
...
1. **Define Generators**: Create individual generators for each field and compose them into a single payload generator.
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-generators-fields
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-generators-payload
    ```
...
2. **Define the Runner**: The `PropertyTestRunner` takes your generator and a test function. It executes your test logic (e.g., making an API request) hundreds of times, each time with a different payload.
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-runner-definition
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-runner-assertions
    ```
...
<Tabs groupId="property-tests">
  <TabItem value="chaos" label="Chaos IDs">
    ...
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-chaos-movies
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-chaos-genres
    ```
  </TabItem>
  <TabItem value="validation" label="Validation">
    ...
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-validation-invalid-json-runner
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-validation-patch-runner
    ```
  </TabItem>
  <TabItem value="upload" label="Upload">
    Tests file uploads with randomized content and filenames.
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-upload-payload
    ```
    ```dart file=../../../../packages/ormed/example/fullstack/test/movie_catalog_property_test.dart#testing-property-upload-runner
    ```
  </TabItem>
</Tabs>
...
If you want more control, you can register external factory classes that define
defaults and named states in a dedicated file. This keeps test data logic
organized as factories grow.

## Playwright UI tests

```ts file=../../../../packages/ormed/example/fullstack/playwright/tests/movie_catalog.spec.ts#testing-playwright-helper-create-movie
```

```ts file=../../../../packages/ormed/example/fullstack/playwright/tests/movie_catalog.spec.ts#testing-playwright-catalog
```

```ts file=../../../../packages/ormed/example/fullstack/playwright/tests/movie_catalog.spec.ts#testing-playwright-create
```

```ts file=../../../../packages/ormed/example/fullstack/playwright/tests/movie_catalog.spec.ts#testing-playwright-edit
```

```ts file=../../../../packages/ormed/example/fullstack/playwright/tests/movie_catalog.spec.ts#testing-playwright-delete
