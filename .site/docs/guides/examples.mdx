...
This produces `lib/src/database/orm_registry.g.dart` with `bootstrapOrm()` (and other helpers).
...
Creates code-first datasource config, datasource entrypoint, registry stubs, and migrations directory.
