...
- How to enable analyzer diagnostics for Ormed usage
- Which categories of ORM mistakes are caught statically
- How to interpret and fix common plugin diagnostics

## Step Outcome

By the end of this page, you should be able to:

- Enable the plugin in your workspace
- Identify diagnostics that indicate correctness vs performance risk
- Suppress only intentionally and locally when needed
...
Prefer targeted, line-level suppression and include a short reason in code review context.
...
Run analyzer in CI and fail builds on new Ormed diagnostics unless explicitly suppressed with rationale.
