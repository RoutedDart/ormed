...
- How schema responsibilities differ from query execution
- How `SchemaDriver` and `SchemaInspector` are used
- How schema previews and state dumps support tooling
