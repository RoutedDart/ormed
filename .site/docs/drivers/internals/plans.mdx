...
- [Driver Internals Overview](./overview)

## What You’ll Learn

- What `QueryPlan`, `MutationPlan`, and `StatementPreview` represent
- How plan compilation stays deterministic
- How to inspect generated statements without executing mutations
