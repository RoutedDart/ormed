...
The migration runner is format-agnostic. It builds a chronological timeline of all registered migrations based on their timestamps. When you run `orm migrate`, it will execute Dart classes and SQL files in the correct order, ensuring your schema evolves predictably regardless of which format you chose for a specific change.
