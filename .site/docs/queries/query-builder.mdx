...
- You already defined at least one model ([Defining Models](../models/defining-models))
- You can boot a datasource from generated helpers ([Quick Start](../getting-started/quick-start))

## What You’ll Learn

- How to compose read queries from simple filters to advanced joins/subqueries
- How to paginate and aggregate safely
- When to switch to relation helpers, repository operations, or raw expressions
...
```dart file=../../examples/lib/queries.dart#joins-basic
```

```dart file=../../examples/lib/queries.dart#joins-complex
```

```dart file=../../examples/lib/queries.dart#joins-variants
...
```dart file=../../examples/lib/queries.dart#subqueries-in-not-in
```

```dart file=../../examples/lib/queries.dart#subqueries-exists
...
```dart file=../../examples/lib/queries.dart#grouping-basic
```

```dart file=../../examples/lib/queries.dart#grouping-having
...
```dart file=../../examples/lib/queries.dart#locking-for-update
```

```dart file=../../examples/lib/queries.dart#locking-shared
...
```dart file=../../examples/lib/queries.dart#crud-create
```

```dart file=../../examples/lib/queries.dart#crud-update-delete
```

```dart file=../../examples/lib/queries.dart#crud-counters-upsert
...
```dart file=../../examples/lib/queries.dart#utility-conditional
```

```dart file=../../examples/lib/queries.dart#utility-debug-value
...
```dart file=../../examples/lib/queries.dart#advanced-joins-where
```

```dart file=../../examples/lib/queries.dart#advanced-joins-subquery
```

```dart file=../../examples/lib/queries.dart#advanced-joins-driver-specific
...
```dart file=../../examples/lib/queries.dart#json-queries-predicates
```

```dart file=../../examples/lib/queries.dart#json-queries-combined
...
```dart file=../../examples/lib/queries.dart#index-hints-core
```

```dart file=../../examples/lib/queries.dart#index-hints-multiple
...
```dart file=../../examples/lib/queries.dart#soft-delete-advanced-querying
```

```dart file=../../examples/lib/queries.dart#soft-delete-advanced-restore-delete
```
...
```dart file=../../examples/lib/queries.dart#order-advanced-random-raw
```

```dart file=../../examples/lib/queries.dart#order-advanced-relations
...
- [Repository](./repository) for write-oriented workflows
- [Relations](./relations) for association loading patterns
- [DataSource](./data-source) for connection and transaction orchestration
