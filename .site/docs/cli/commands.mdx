...
The CLI uses `orm.yaml` for configuration (see [Getting Started → Configuration](../getting-started/configuration) for the full reference). Minimal shapes:

<Tabs groupId="cli-orm-yaml" defaultValue="single">
