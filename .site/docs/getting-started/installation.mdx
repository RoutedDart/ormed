...
Scaffold code-first runtime datasource config, migration registry, and seed stubs:
...
- [Quick Start Guide](./quick-start) - build your first working model + migration + query
- [Adopt Existing Project](./adopt-existing-project) - integrate Ormed into an existing service incrementally
- [Configuration](./configuration) - understand single/multi-connection runtime setup
