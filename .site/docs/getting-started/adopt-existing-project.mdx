...
Before you start: [Installation](./installation); Familiarity with your current DB schema and deployment flow.
...
dependencies:
  ormed: ^0.3.0
  ormed_sqlite: ^0.4.0 # or ormed_postgres / ormed_mysql / ormed_d1
