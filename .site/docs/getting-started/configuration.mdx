...
Before you start: You completed [Installation](./installation); You ran `ormed init` from [Quick Start](./quick-start) or [Adopt Existing Project](./adopt-existing-project).
