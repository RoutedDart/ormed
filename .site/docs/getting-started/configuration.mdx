...
<Tabs groupId="orm-yaml-shape" defaultValue="single">
...
This only affects generation defaults (what `orm make` produces). The migration registry can still contain both styles.
