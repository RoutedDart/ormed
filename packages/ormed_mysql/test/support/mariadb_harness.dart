...
class MariaDbTestHarness implements DriverTestHarness {
  MariaDbTestHarness._(this.adapter, this.registry, this.context);
  ...
  static Future<MariaDbTestHarness> connect() async {
    final url =
    ...
    final harness = MariaDbTestHarness._(adapter, registry, context);
