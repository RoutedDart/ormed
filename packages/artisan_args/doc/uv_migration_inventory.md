...
- `packages/artisan_args/lib/src/tui/program.dart:809`
...
- `packages/artisan_args/lib/src/tui/bubbles/components/progress_bar.dart:65`
...
- `packages/artisan_args/example/tui/examples/chat/main.dart:82`
...
- `packages/artisan_args/example/tui/input.dart:293` (prints result after exit)
- `packages/artisan_args/example/tui/list.dart:137` (prints result after exit, UV enabled)
- `packages/artisan_args/example/tui/examples/result/main.dart:71` (prints result after exit)
- `packages/artisan_args/example/tui/examples/file-picker/main.dart:119` (prints selection after exit)
...
- `packages/artisan_args/lib/src/tui/bubbles/components/text.dart:86`
  - `final remaining = width - label.length;`
  - Status: fixed (`Style.visibleLength(label)`).

### 3.2 StyledBlock uses `.length` for prefix padding

- `packages/artisan_args/lib/src/tui/bubbles/components/styled_block.dart:73`
  - Uses `prefixText.length` to compute `blockWidth`.
- `packages/artisan_args/lib/src/tui/bubbles/components/styled_block.dart:82`
...
- `packages/artisan_args/lib/src/tui/bubbles/viewport.dart:249`
...
- `packages/artisan_args/lib/src/tui/bubbles/help.dart:268`
...
- `packages/artisan_args/lib/src/tui/bubbles/textinput.dart`
...
- `packages/artisan_args/lib/src/tui/bubbles/anticipate.dart`
...
- `packages/artisan_args/lib/src/tui/bubbles/confirm.dart`
