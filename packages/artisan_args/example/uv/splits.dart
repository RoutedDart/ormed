...
void main() async {
  ...
  final blue = Cell(content: ' ', style: const Style(bg: UvColor.basic16(4))); // Blue
  final red = Cell(content: ' ', style: const Style(bg: UvColor.basic16(1)));  // Red
  final green = Cell(content: ' ', style: const Style(bg: UvColor.basic16(2))); // Green
