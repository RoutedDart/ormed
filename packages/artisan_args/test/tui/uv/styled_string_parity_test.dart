...
Cell _newWcCell(String s, Style? style, Link? link) {
            ...
            (
              ...
              expected: _bufferFromLines([
                [
                  ...
                  _newWcCell(
                    'G',
                    Style(fg: const UvColor.basic16(2), attrs: Attr.italic),
                    null,
                  ),
                  _newWcCell(
                    'r',
                  ...
                  _newWcCell(
                    'Y',
                    Style(fg: const UvColor.basic16(3), attrs: Attr.reverse),
                    null,
                  ),
                  _newWcCell(
                    'e',
                  ...
                  _newWcCell(
                    'P',
                    Style(fg: const UvColor.basic16(5), attrs: Attr.blink),
                    null,
                  ),
                  _newWcCell(
                    'u',
                ...
                [
                  ...'Single'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(underline: UnderlineStyle.single),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'Double'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(underline: UnderlineStyle.double),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'Curly'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(underline: UnderlineStyle.curly),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'Dotted'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(underline: UnderlineStyle.dotted),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'Dashed'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(underline: UnderlineStyle.dashed),
                          null,
                        ),
                      ),
                ],
                ...
                [
                  ...'RGB Red'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(fg: UvColor.rgb(255, 0, 0)),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'RGB Green BG'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(bg: UvColor.rgb(0, 255, 0)),
                          null,
                        ),
                      ),
                  _newWcCell(' ', null, null),
                  ...'256 Blue'
                      ...
                      .map(
                        (ch) => _newWcCell(
                          ch,
                          const Style(fg: UvColor.indexed256(33)),
                          null,
                        ),
                      ),
                ],
            ...
            (
              ...
              expected: _bufferFromLines([
                [
                  ...
                  _newWcCell(
                    'e',
                    Style(fg: const UvColor.basic16(1), attrs: Attr.bold),
                    null,
                  ),
                  _newWcCell(
                    'd',
